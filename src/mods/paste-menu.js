...
class PasteMenu extends Module {
    ...
    registerButtons() {
        ...
        $("#pasteButtonMenu").css("height", $(".logwrapper").height());
        this.addElementListener(".bottomButton.paste", "click", this.onButtonClick);

        let pasteButtons = document.getElementsByClassName(".bottomButton.paste");
